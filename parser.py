...
The file follows the following format:
	 ...
	 bezier: add a bezier curve to the edge matrix -
         ...
         ident: set the csystems matrix to the identity matrix -
         scale: create a scale matrix,
                then multiply the csystems matrix by the scale matrix -
                takes 3 arguments (sx, sy, sz)
         move: create a translation matrix,
               then multiply the csystems matrix by the translation matrix -
               takes 3 arguments (tx, ty, tz)
         rotate: create a rotation matrix,
                 then multiply the csystems matrix by the rotation matrix -
                 takes 2 arguments (axis, theta) axis should be x y or z
         apply: apply the current csystemsation matrix to the edge and POLYGON matrices
